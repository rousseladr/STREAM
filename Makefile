CC = gcc
CFLAGS = -Ofast -fopenmp -mcmodel=large -fno-PIC
#CFLAGS = -O0 -g -march=native -fopenmp -mcmodel=large -fno-PIC
CFLAGS_MILAN = -march=znver3 -DSTREAM_ARRAY_SIZE=272014600
CFLAGS_TURIN = -march=znver5 -DSTREAM_ARRAY_SIZE=340018250
CFLAGS_GH200 = -mcpu=neoverse-v2 -DSTREAM_ARRAY_SIZE=242263000
CFLAGS_MI300A = -march=native -DSTREAM_ARRAY_SIZE=195000000
...
stream_c.turin: stream.c
        $(CC) $(CFLAGS) $(CFLAGS_TURIN) -DNTIMES=200 -DSTREAM_TYPE=double stream.c -o $@
